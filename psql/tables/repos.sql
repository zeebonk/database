...
COMMENT on column app_hidden.repos.owner_uuid is 'The GitHub Organization that owns this repository.';
...
CREATE UNIQUE INDEX repos_slug on app_hidden.repos (owner_uuid, name);
