...
BEGIN
  ...
  INSERT INTO owner_services (uuid, owner_uuid, service_id, username) values (v_user_servce1_uuid, v_user1_uuid, '23598043290', 'user1');
  INSERT INTO repos (uuid, owner_service_uuid, service_id, name) values (v_repo1_uuid, v_user_servce1_uuid, '92385348957239', 'repo1');
